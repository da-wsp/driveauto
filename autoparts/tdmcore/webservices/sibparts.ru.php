...
foreach($arWsParts as $arPart){
	$ch = curl_init();
	curl_setopt($ch, CURLOPT_URL,"http://sibparts.ru.public.api.abcp.ru/search/articles/?userlogin=".$arWS['LOGIN']."&userpsw=".$Passw."&number=".urlencode($arPart['ARTICLE'])."&brand=".urlencode($arPart['BRAND'])."&useOnlineStocks=".$useOnlineStocks);
	curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
	$json = curl_exec($ch);
	curl_close($ch);
	$jsonRes = json_decode($json);
	//echo "http://sibparts.ru.public.api.abcp.ru/search/articles/?userlogin=".$arWS['LOGIN']."&userpsw=".$Passw."&number=".urlencode($arPart['ARTICLE'])."&brand=".urlencode($arPart['BRAND'])."&useOnlineStocks=".$useOnlineStocks;
