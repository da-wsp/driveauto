...
<!--
                    <div class="overlay">
                        <h2><span class="highlight"><?php echo $category['name']; ?></span></h2>
                        <p> 
                            <a href="#">LINK HERE</a>
                        </p> 
                    </div>
  			...
  			<div class="col-sm-3">
  				<div class="image <?php if($theme_options->get( 'product_image_effect' ) == '1') { echo 'image-swap-effect'; } ?>">
	  				...
	  				<a href="<?php echo $product['href']; ?>">
                        ...
                        <img class="img-responsive" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>"  <?php if($theme_options->get( 'product_image_effect' ) == '2') { echo 'class="zoom-image-effect"'; } ?> />
	  				</a>
	  				<?php } else { ?>
