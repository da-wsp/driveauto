	...
	<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		...
		<div id="tb_store_select">
			...
			<?php foreach ($stores as $store): ?>
				<option value="<?php echo HTTPS_SERVER . 'index.php?route=module/stowear&store_id=' . $store['store_id'] . '&token=' . $_GET['token']; ?>"<?php if($store_id == $store['store_id']) echo ' selected="selected"'; ?>><?php echo $store['name']; ?></option>
			<?php endforeach; ?>
			</select>
		</div>
						...
						<div id="tab_colors" class="tab-content">
							...
							<div class="colors_left">
								...
								<div class="input" style="border: none;padding-bottom: 6px">
									...
									<div class="own_image" onclick="image_upload('cart_icon', 'preview112');">
									
										<input type="hidden" name="cart_icon" value="<?php echo $cart_icon; ?>" id="cart_icon" />
										<img src="../image/<?php if($cart_icon == '') { echo 'no_image.jpg'; } else { echo $cart_icon; } ?>" alt="" id="preview112" />
