				...
				<div>
					<div class="tabs clearfix">
						...
						<div id="tabs" class="htabs main-tabs">
							...
							<a href="#tab-module-<?php echo $module_row; ?>" id="module-<?php echo $module_row; ?>">Tab <?php echo $module_row; ?> &nbsp;<img src="view/image/delete.png"  alt="" onclick="$('.vtabs a:first').trigger('click'); $('#module-<?php echo $module_row; ?>').remove(); $('#tab-module-<?php echo $module_row; ?>').remove(); return false;" /></a>
							<?php $module_row++; ?>
							<?php } ?>
							<span id="module-add">Add Tab &nbsp;<img src="view/image/add.png" alt="" onclick="addModule();" /></span>
						</div>
						...
						<div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
							...
							<script type="text/javascript">
								$('#product-autocomplete-input-<?php echo $module_row; ?>').autocomplete({
									...
									select: function(event, ui) {
										...
										var id_module = $(this).attr('title');
										$('input[name=\'product_tabs[' + id_module + '][product_id]\']').val(ui.item.value);
							...
							<div id="carousel_<?php echo $module_row; ?>_items" class="tabs_add_element clearfix">
								...
								<?php if(isset($module['tabs'])) { foreach($module['tabs'] as $item) { ?>
									<a href="#carousel-<?php echo $module_row; ?>-element-<?php echo $i; ?>" id="element-<?php echo $element; ?>"><?php echo $i; ?> &nbsp;<img src="view/image/delete.png" alt="" onclick="$('#carousel_<?php echo $module_row; ?>_items a:first').trigger('click'); $('#element-<?php echo $element; ?>').remove(); $('#carousel-<?php echo $module_row; ?>-element-<?php echo $i; ?>').remove(); return false;" /></a>
								<?php $i++; $element++; ?>
								<?php } } ?>
								<img src="view/image/add.png" alt="" onclick="addElement(<?php echo $module_row; ?>);">
							</div>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '		<img src="view/image/add.png" alt="" onclick="addElement('+module_row+');">';
		html += '	</div>';
	...
	$('#module-add').before('<a href="#tab-module-' + module_row + '" id="module-' + module_row + '">Tab ' + module_row + ' &nbsp;<img src="view/image/delete.png" alt="" onclick="$(\'.vtabs a:first\').trigger(\'click\'); $(\'#module-' + module_row + '\').remove(); $(\'#tab-module-' + module_row + '\').remove(); return false;" /></a>');
...
function addElement(module_row) {
	...
	$('#carousel_' + module_row + '_items > img').before('<a href="#carousel-' + module_row + '-element-' + elements + '" id="element-' + elements + '">' + elements + ' &nbsp;<img src="view/image/delete.png" alt="" onclick="$(\'#carousel_'+ module_row +'_items a:first\').trigger(\'click\'); $(\'#element-' + elements+ '\').remove(); $(\'#carousel-' + module_row + '-element-' + elements + '\').remove(); return false;" /></a>');
