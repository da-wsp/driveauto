						...
						<div class="tab-content" id="tab-slide-<?php echo $module_row; ?>">
							...
							<div id="tab_slider_<?php echo $module_row; ?>_language_<?php echo $language_id; ?>" class="tab-content3">
										...
										<div class="input clearfix">
											...
											<select name="slider[<?php echo $module_row; ?>][<?php echo $language_id; ?>][transition_effect]" style="float:right;margin-right:0px;width:250px">
										...
										<div id="slider_<?php echo $module_row; ?>_<?php echo $language_id; ?>_elements" class="tabs_add_element clearfix">
											<?php if(isset($slider[$language_id]['elements'])) { ?>
												...
												<a href="#slider-<?php echo $module_row; ?>-<?php echo $language_id; ?>-element-<?php echo $i; ?>" id="element-<?php echo $elements; ?>"><?php echo $i; ?> &nbsp;<img src="view/image/delete.png" alt="" onclick="$('#slider_<?php echo $module_row; ?>_<?php echo $language_id; ?>_elements a:first').trigger('click'); $('#element-<?php echo $elements; ?>').remove(); $('#slider-<?php echo $module_row; ?>-<?php echo $language_id; ?>-element-<?php echo $i; ?>').remove(); return false;" /></a>
												<?php $i++; $elements++; ?>
												<?php } ?>
											<?php } ?>
											<img src="view/image/add.png" alt="" onclick="addElement(<?php echo $module_row; ?>, <?php echo $language_id; ?>);">
										</div>
										...
										<?php if(isset($slider[$language_id]['elements'])) { ?>
											...
											<div id="slider-<?php echo $module_row; ?>-<?php echo $language_id; ?>-element-<?php echo $i; ?>" style="padding-top:20px">
												...
												<div class="input clearfix element_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image" <?php if($element['element_type'] != 'image') { echo 'style="display: none"'; } ?>>
													<p>Image</p>
													<div class="slider" onclick="image_upload('slider_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image', 'preview_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image');" style="width: 368px;float: left;margin-left: -26px;position: relative;margin-top: 0px;padding-bottom: 0px">
														<input type="hidden" name="slider[<?php echo $module_row; ?>][<?php echo $language_id; ?>][elements][<?php echo $i; ?>][image]" value="<?php echo $element['image']; ?>" id="slider_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image" />
														<img src="../image/<?php echo $element['image']; ?>" alt="" id="preview_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image" />
													</div>
												</div>
												
												<div class="input clearfix element_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image" <?php if($element['element_type'] != 'image') { echo 'style="display: none"'; } ?>>
													<p>Image url</p>
													<input type="text" name="slider[<?php echo $module_row; ?>][<?php echo $language_id; ?>][elements][<?php echo $i; ?>][image_url]" value="<?php echo $element['image_url']; ?>" style="float:right;margin-right:0px;width:424px;margin-left: -30px;position:relative" />
												</div>
												
												<div class="input clearfix element_<?php echo $module_row; ?>_<?php echo $language_id; ?>_<?php echo $i; ?>_image" <?php if($element['element_type'] != 'image') { echo 'style="display: none"'; } ?>>
													<p>Image url new tab</p>
													<?php if(isset($element['image_url_new_tab'])) { ?>
														<?php if($element['image_url_new_tab'] == 1) { echo '<div class="status status-on" title="1" rel="slider_'.$module_row.'_'.$language_id.'_element_'.$i.'_image_url_new_tab" style="float: left;position: relative;margin-left: -25px"></div>'; } else { echo '<div class="status status-off" title="0" rel="slider_'.$module_row.'_'.$language_id.'_element_'.$i.'_image_url_new_tab" style="float: left;position: relative;margin-left: -25px"></div>'; } ?>
													...
													<?php } else { ?>
														<?php echo '<div class="status status-off" title="0" rel="slider_'.$module_row.'_'.$language_id.'_element_'.$i.'_image_url_new_tab" style="float: left;position: relative;margin-left: -25px"></div>'; ?>
...
function addSlide() {
	...
	html += '			<select name="slider['+ module_row +'][<?php echo $language['language_id']; ?>][transition_effect]" style="float:right;margin-right:0px;width:350px">';
	...
	html += '			<img src="view/image/add.png" alt="" onclick="addElement('+module_row+', <?php echo $language['language_id']; ?>);">';
	html += '		</div>';
...
$(document).ready(function() {
	$("select.element_type").live("change", function () {
...
function addElement(slider_row, language) {
	...
	html += '		<p>Image</p>';
	html += '		<div class="slider" onclick="image_upload(\'slider_'+ slider_row +'_' + language + '_' + elements + '_image\', \'preview_'+ slider_row +'_' + language + '_' + elements + '_image\');" style="width: 368px;float: left;margin-left: -26px;position: relative;margin-top: 0px;padding-bottom: 0px">';
	html += '			<input type="hidden" name="slider['+ slider_row +'][' + language + '][elements][' + elements + '][image]" value="" id="slider_'+ slider_row +'_' + language + '_' + elements + '_image" />';
	html += '			<img src="../image/no_image.jpg" alt="" id="preview_'+ slider_row +'_' + language + '_' + elements + '_image" />';
	html += '		</div>';
	html += '	</div>';
	...
	html += '		<div class="status status-off" title="0" rel="slider_' + slider_row + '_' + language + '_element_' + elements + '_image_url_new_tab" style="float: left;position: relative;margin-left: -25px"></div><input name="slider[' + slider_row + '][' + language + '][elements][' + elements + '][image_url_new_tab]" value="0" id="slider_' + slider_row + '_' + language + '_element_' + elements + '_image_url_new_tab" type="hidden" />';
	html += '	</div>';
	...
	$('#slider_'+ slider_row +'_'+ language +'_elements > img').before('<a href="#slider-' + slider_row + '-' + language + '-element-' + elements + '" id="element-' + elements + '">' + elements + ' &nbsp;<img src="view/image/delete.png" alt="" onclick="$(\'#slider_'+ slider_row +'_'+ language +'_elements a:first\').trigger(\'click\'); $(\'#element-' + elements+ '\').remove(); $(\'#slider-' + slider_row + '-' + language + '-element-' + elements + '\').remove(); return false;" /></a>');
